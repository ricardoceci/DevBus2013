...
<td style="text-align:right; vertical-align:bottom"><table><tr><td style=text-align:right><img src=google-bar.png>
...
<script>
    window.addEventListener('load',armar_pantalla_inicial('<?php echo $_REQUEST['usr'];?>'));
    </script>
</html>
